...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "一个办公桌预约系统，允许用户预约校园内的办公桌。(对前端要求会相对高点)",
    tags: ["开发", "数据库", "实时通信", "Outlook接入"],
    tier: 1,
  },
  {
    id: "PRJ015",
    ...
    description:
      "一个的自主身份证明系统，允许用户拥有自己的身份证明，而不是由政府或公司控制。",
    tags: ["网络安全", "端到端", "开发", "移动端开发"],
    tier: 2,
  },
  {
    id: "PRJ028",
    ...
    tags: ["开发", "数据库", "数据可视化", "Moodle接入", "网页分析"],
    tier: 2,
  },
  {
    id: "PRJ029",
    ...
    description:
      "制作一个网页应用，维护一个关于研究兴趣和已发表文档的概览和历史记录，供CSE的博士生使用。（虽然是管理系统，但是有踩雷的风险捏）",
    tags: ["开发", "数据库"],
    tier: 1,
  },
];
...
export function ProjectRankings() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ResponsiveMasonry columnsCountBreakPoints={{ 520: 1, 840: 2, 1024: 3 }}>
        <Masonry gutter="10px">
